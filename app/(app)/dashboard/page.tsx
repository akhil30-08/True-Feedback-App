...
const Dashboard = () => {
   ...
   return (
      <div className='my-8 p-3 lg:p-6 bg-white rounded w-full max-w-6xl'>
         <h1 className='text-4xl font-bold mb-4'>User Dashboard</h1>

         <div className='mb-4'>
            <h2 className='text-lg font-semibold mb-2'>Copy Your Unique Link</h2>{' '}
            <div className='flex max-sm:flex-col items-center justify-between gap-3 max-sm:items-start'>
               <input
                  type='text'
                  value={profileURL}
                  disabled
                           ...
                           render={({ field }) => (
                              <FormItem className='flex flex-row items-center rounded-lg gap-5 p-4'>
                                 ...
                                 <div className='space-y-0.5'>
                                    ...
                                    <FormDescription className='text-lg'>{isAcceptingMessage ? 'ON' : 'OFF'}</FormDescription>
                                 </div>
                              </FormItem>
                           )}
                        />
